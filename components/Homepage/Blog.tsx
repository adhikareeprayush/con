  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 px-4 sm:px-8 md:px-12 lg:px-20 py-10 sm:py-14 md:py-18 gap-8 sm:gap-12 md:gap-16 lg:gap-20 bg-[#FAFAFA]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 col-span-1 lg:col-span-2">
        <h2 className="col-span-1 text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-primary font-jakarta font-semibold leading-[130%] tracking-tighter">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full col-span-1 lg:col-span-2 gap-6 sm:gap-8">
        <BlogCard
          ...
          excerpt="Discover effective SEO strategies to enhance your website's visibility and drive organic traffic. From keyword research to link building, learn how to optimize your site for better search engine rankings."
        ...
        <BlogCard
          ...
          excerpt="Explore the latest trends and techniques in content marketing for 2024. This comprehensive guide covers everything from content creation to distribution, helping you engage your audience and grow your brand."
        ...
        <BlogCard
          ...
          excerpt="Stay ahead in the digital marketing game with our list of the top 10 tools that can streamline your campaigns, improve analytics, and boost your ROI."
